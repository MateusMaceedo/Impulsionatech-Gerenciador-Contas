...
using Gerenciador.Transferencia.Infra.Configuration;
using Gerenciador.Transferencia.WebAPI.Exception;
using Gerenciador.Transferencia.Application.Utilities;
